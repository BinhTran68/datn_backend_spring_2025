...
public enum ErrorCode {
    BILL_NOT_EXISTS(6000, "bill ko tồn tại"),
    ...
    COLOR_EXISTS(1200, "color đã tồn tại"),
    NAME_EXISTS(3000, "tên đã tồn tại"),
    PRODUCT_DETAIL_EXISTS(4100, "Đã tồn tại chi tiết này rồi");

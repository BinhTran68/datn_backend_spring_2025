...
//                (p.id,p.promotionCode,p.promotionName,p.promotionType,p.discountValue,p.quantity,p.startDate,p.endDate,p.statusPromotion)
//                FROM Promotion  p
//            """)
////    ,p.quantity
...
//    AND (:status IS NULL OR p.statusPromotion = :status)
//""")
